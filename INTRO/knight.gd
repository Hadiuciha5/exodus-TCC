...
var speed = 30 # Kecepatan NPC
var move_direction = Vector2.RIGHT # Arah awal NPC
var timer_duration = 1.0 # Durasi pergerakan dalam satu langkah (detik)
var steps_forward = 4 # Jumlah langkah ke depan
var steps_backward = 4 # Jumlah langkah ke belakang
...
var pause_duration = 0.1 # Durasi jeda (detik)
